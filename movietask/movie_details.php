...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <li class="nav-item">
        <a class="nav-link mx-3" href="dashboard.php">Movies</a>
      </li>
      <li class="nav-item">
  ...
  <div class="container-fluid mt-4">
    <div class="row">
      <div class="col-lg-6">
        <img src="<?php echo $movieDetails['Poster']; ?>" class="card-img-top image" alt="Movie Image">
        <h2 class="mb-3"><?php echo $movieDetails['Title']; ?></h2>
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="screen" name="screen" value="Demo Screen" readonly>
  </div>
  <div class="mb-3">
